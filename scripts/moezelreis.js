$(window).on('load', function() {
  ...
  function changeAttribution() {
    ...
    var credit = 'View <a href="' + googleDocURLmoezel2024 + '" target="_blank">data</a>';
   ...
   $.ajax({
       ...
       error: function() {
         ...
         if (typeof googleApiKey !== 'undefined' && googleApiKey) {
          ...
          var spreadsheetId = googleDocURLmoezel2024.indexOf('/d/') > 0
            ? googleDocURLmoezel2024.split('/d/')[1].split('/')[0]
            : googleDocURLmoezel2024
